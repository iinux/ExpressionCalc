package com.mycompany.helloworld.ognl;
...
public class OgnlStudy {
    ...
    public void test1() throws OgnlException {
        ...
        ans = Ognl.getValue(Ognl.parseExpression("@com.mycompany.helloworld.ognl.StaticDemo@showDemo(20)"), context,
                context.getRoot());
        System.out.println("静态类方法执行：" + ans);

        ans = Ognl.getValue(Ognl.parseExpression("@com.mycompany.helloworld.ognl.StaticDemo@num"), context,
                context.getRoot());
        System.out.println("静态类成员访问：" + ans);

        //ans = Ognl.getValue(Ognl.parseExpression("@com.mycompany.helloworld.ognl.StaticDemo@num=1314"), context,
        //        context.getRoot());
        ans = Ognl.getValue(Ognl.parseExpression("#field=@com.mycompany.helloworld.ognl.StaticDemo@class.getDeclaredField(\"num\"), #field.setAccessible(true), #field.set(null,1234)"),
                context, context.getRoot());
        ...
        ans = Ognl.getValue(Ognl.parseExpression(
                "#print.print(\"{'name':'xx', 'age': 20}\", @com.mycompany.helloworld.ognl.ADemo@class)"), context,
                context.getRoot());
        ...
        ans = Ognl.getValue(
                Ognl.parseExpression("#print.print(\"print enum\", @com.mycompany.helloworld.ognl.OgnlEnum@CONSOLE)"),
                context, context.getRoot());
        ...
        expression = Ognl.parseExpression("#print.print(\"对象构建\", new com.mycompany.helloworld.ognl.ADemo(\"test\", 20))");
        ...
        expression = Ognl.parseExpression("#print.print(\"对象构建\", (#demo=new com.mycompany.helloworld.ognl.ADemo(), #demo.setName(\"一灰灰\"), #demo))");
        ans = Ognl.getValue(expression, context, context.getRoot());
        System.out.println("对象传参：" + ans);
